...
;(function($,document,window,undefined) {
	...
	$.fn.jCounter = function(options,callback) {
		...
		var settings = {
			...
			date: null,
			debugLog: false,
			serverDateSource: 'dateandtimae.php', //path to dateandtime.php file (i.e. http://my-domain.com/dateandtime.php)
			format: 'dd:hh:mm:ss',
